...
export const messages: Messages = {
	[LOCALES.ENGLISH]: {
		...
		[MESSAGES.SETTINGS_MENU]: 'Settings menu',
		...
		[MESSAGES.MICROPHONE_ON]: 'Microphone on',
		[MESSAGES.MICROPHONE_OFF]: 'Microphone off',
		...
		[MESSAGES.POSTS_UNREAD_COUNT]: 'Unread posts count',
		...
		[MESSAGES.CLOSE_MODAL]: 'Close modal window',
		[MESSAGES.FEEDS]: 'Feeds',
		[MESSAGES.NO_FEEDS]: 'No feeds yet',
		[MESSAGES.ADD_NEW_FEED]: 'Add new feed',
		...
		[MESSAGES.FEEDS_RELOAD_WARNING]: 'Are you sure you want to reload feed?',
	...
	[LOCALES.RUSSIAN]: {
		...
		[MESSAGES.SETTINGS_MENU]: 'Меню настроек',
		...
		[MESSAGES.MICROPHONE_ON]: 'Микрофон включен',
		[MESSAGES.MICROPHONE_OFF]: 'Микрофон выключен',
		[MESSAGES.PAGINATION]: 'Нумерация страниц',
		[MESSAGES.FIND]: 'Найти',
		[MESSAGES.NOT_FOUND]: 'Не найдено',
		[MESSAGES.RESET]: 'Сброс',
		[MESSAGES.DELETE]: 'Удалить',
		[MESSAGES.RELOAD]: 'Перезагрузить',
		[MESSAGES.ACTIVE]: 'Активный',
		[MESSAGES.POSTS]: 'Посты',
		[MESSAGES.POSTS_UNREAD_COUNT]: 'Количество непрочитанных постов',
		...
		[MESSAGES.CLOSE_MODAL]: 'Закрыть модальное окно',
		[MESSAGES.FEEDS]: 'Каналы',
		[MESSAGES.NO_FEEDS]: 'Каналов пока нет',
		[MESSAGES.ADD_NEW_FEED]: 'Добавить новый канал',
		...
		[MESSAGES.FEEDS_RELOAD_WARNING]:
			'Вы уверены, что хотите перезагрузить канал?',
